...
def data_prepare(dataset_name, dataset_source, dataset_root):
    # check dataset support
    dataset = None
    if dataset_name == 's3dis':
        dataset = s3dis.PrepareDataset(dataset_source, dataset_root)
...
if __name__ == "__main__":
    ...
    data_prepare(args.dataset_name, args.dataset_source, args.dataset_root)
